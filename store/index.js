...
export const state = () => ({
    posts: [
        {id: 1,
            ...
            Remember laughter?`,
            img: 'https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcSJVJMi_rbohZyjmjeLr5T8BQush328OEH0CA&usqp=CAU',
            show: 'true',
            date: Date.now()       
        },
        {id: 2,
            ...
            And she's buying a stairway to heaven`,
            img: 'https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcRKJqZq2al1zZk_M1gUcQhQtAsehhCN4d46lA&usqp=CAU',
            show: 'true',
            date: Date.now()       
        },
        {id: 3,
            ...
            img: 'https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcS_89V5rnMgBFQLYTLeFZ1cBHUJpkz4rZZExA&usqp=CAU',
            show: 'true',
            date: Date.now()       
        },
        {id: 4,
            ...
            Ah-keep it cooling baby
            Ah-keep it cooling baby`,
            img: 'https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcS6XD6zqXGWXiepaB1HcuJ-wdCi0WNtNVx-uQ&usqp=CAU',
            show: 'true',
            date: Date.now()       
        },
        {id: 5,
            title: 'Kashmir',
            subtitle: 'Led Zeppelin',
            text: `Oh, let the sun beat down upon my face
        ...
        {id: 6,
            title: 'Ramble On',
            subtitle: 'Led Zeppelin',
            text: `Leaves are falling all around
            ...
            I keep rambling, baby`,
            img: 'https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcReJVmCXZE20Sgd_gSk7AUZFnrcSlBIJqJNIg&usqp=CAU',
            show: 'true',
            date: Date.now()       
        },
    ], 
...
export const mutations = {
    ...
    selectPost(state, payload){
        state.post = state.posts.find(item => item.id == payload)
    },
    editPost(state, payload){
        const x = state.posts.map(item => item.id == payload.id ? payload : item)
        state.posts = x
    },
}
